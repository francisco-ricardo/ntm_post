...
\begin{document}
    ...
    The input degree of a vertex \emph{v} consists of the number of 
    incident edges in \emph{v}.
    The output degree of a vertex \emph{v} is the number of 
    incident edges from \emph{v}.
